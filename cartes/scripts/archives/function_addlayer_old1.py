...
#					style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(image))# '<b> Appelation :</b>\n %s Grand Cru \n '%(data[key]['properties']['appellation']),max_width = 250, min_width = 250))
	...
	if description :
		...
		for key in data.keys():
			...
			if data[key]['properties']['nez'] != '' :

				if data[key]['properties']['mets_et_vin'] != '' :
				...
				# get information on the wine
							name = data[key]['image']
							info = '<p style = "font-family:cursive"> <ul> <li> <b> Appellation : </b> %s </li> <li> <b> Climat : </b> %s </li> </ul> \n <i> Image récupérée sur <a href ="https://www.vivino.com/"> Vivino</a>.</i></p> <p style = "font-family:cursive"> <b> Caractéristiques du vin </b> <ul> Nez : %s </ul><ul> Bouche : %s </ul> <ul> Robe : %s </ul> <ul> Accords mets et vins : %s </ul> </p>' %(data[key]['properties']['appellation'],
								data[key]['properties']['climat'], data[key]['properties']['nez'], data[key]['properties']['bouche'], data[key]['properties']['oeil'], data[key]['properties']['mets_et_vin'] )
							pop_up_content = get_image_from_folder(name, loc_image, info)
							folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(pop_up_content, max_width = 600, min_width = 250, html_parse = True))

						if data[key]['properties']['climat'] == '':

							name = data[key]['image']
							info = '<p style = "font-family:cursive"> <ul> <li> <b>  Appellation :</b> %s </li> </ul> \n <i> Image récupérée sur <a href ="https://www.vivino.com/"> Vivino</a>.</i> </p><p style = "font-family:cursive"> <b> Caractéristiques du vin </b> <ul> Nez : %s </ul><ul> Bouche : %s </ul> <ul> Robe : %s </ul> <ul> Accords mets et vins : %s </ul> </p>' %(data[key]['properties']['appellation'],
								data[key]['properties']['nez'], data[key]['properties']['bouche'], data[key]['properties']['oeil'], data[key]['properties']['mets_et_vin'] )
							pop_up_content = get_image_from_folder(name, loc_image, info)
							folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(pop_up_content, max_width = 600, min_width = 250, html_parse = True))
						#folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(image))# '<b> Appelation :</b>\n %s'%(data[key]['properties']['appellation']), max_width = 250, min_width = 250))
...
#							style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(image))# '<b> Appelation :</b>\n %s Grand Cru \n '%(data[key]['properties']['appellation']),max_width = 250, min_width = 250))
				...
				# get information on the wine
							name = data[key]['image']
							info = '<p style = "font-family:cursive"> <ul> <li> <b> Appellation : </b> %s </li> <li> <b> Climat : </b> %s </li> </ul> \n <i> Image récupérée sur <a href ="https://www.vivino.com/"> Vivino</a>.</i></p> <p style = "font-family:cursive"> <b> Caractéristiques du vin </b> <ul> Nez : %s </ul><ul> Bouche : %s </ul> <ul> Robe : %s </ul></p>' %(data[key]['properties']['appellation'],
								data[key]['properties']['climat'], data[key]['properties']['nez'], data[key]['properties']['bouche'], data[key]['properties']['oeil'])
							pop_up_content = get_image_from_folder(name, loc_image, info)
							folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(pop_up_content, max_width = 600, min_width = 250, html_parse = True))
						...
						if data[key]['properties']['climat'] == '':
							...
							name = data[key]['image']
							info = '<p style = "font-family:cursive"> <ul> <li> <b>  Appellation :</b> %s </li> </ul> \n <i> Image récupérée sur <a href ="https://www.vivino.com/"> Vivino</a>.</i> </p><p style = "font-family:cursive"> <b> Caractéristiques du vin </b> <ul> Nez : %s </ul><ul> Bouche : %s </ul> <ul> Robe : %s </ul> </p>' %(data[key]['properties']['appellation'],
								data[key]['properties']['nez'], data[key]['properties']['bouche'], data[key]['properties']['oeil'])
							pop_up_content = get_image_from_folder(name, loc_image, info)
							folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(pop_up_content, max_width = 600, min_width = 250, html_parse = True))
						#folium.GeoJson(data[key],style_function= lambda feature : style).add_to(feature_group).add_child(folium.Popup(image))# '<b> Appelation :</b>\n %s'%(data[key]['properties']['appellation']), max_width = 250, min_width = 250))
